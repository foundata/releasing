...
<img src="https://raw.githubusercontent.com/foundata/scanmole/refs/heads/main/packages/scanmole-gui/src/scanmole_gui/icons/hicolor/scalable/apps/com.foundata.ScanMole.svg" alt="ScanMole logo: a mole with glasses holding a scanned document" height="128" /> **⭐ Found this useful? Support open-source and star this project:** [GitHub repository](https://github.com/foundata/scanmole)
<!-- rumdl-enable MD033 -->
...
<!-- rumdl-disable MD033 -->
<!-- HTML for consistent rendering across limited platform parsers -->
[<img src="https://raw.githubusercontent.com/foundata/scanmole/refs/heads/main/assets/images/screenshots/scanmole-gui-01-main.png" alt="Screenshot: The ScanMole GUI's two-column layout with a connected scanner, ready to scan" height="128" />](https://github.com/foundata/scanmole/blob/main/assets/images/screenshots/scanmole-gui-01-main.png)
&#160;
[<img src="https://raw.githubusercontent.com/foundata/scanmole/refs/heads/main/assets/images/screenshots/scanmole-gui-02-scan-result.png" alt="Screenshot: The ScanMole GUI after a finished scan, with saved pages and a skipped blank in the result bar" height="128" />](https://github.com/foundata/scanmole/blob/main/assets/images/screenshots/scanmole-gui-02-scan-result.png)
&#160;
[<img src="https://raw.githubusercontent.com/foundata/scanmole/refs/heads/main/assets/images/screenshots/scanmole-gui-03-settings.png" alt="Screenshot: The ScanMole GUI's settings dialog, covering page size, deskew, PDF/A and feeder behavior" height="128" />](https://github.com/foundata/scanmole/blob/main/assets/images/screenshots/scanmole-gui-03-settings.png)
&#160;
[<img src="https://raw.githubusercontent.com/foundata/scanmole/refs/heads/main/assets/images/screenshots/scanmole-gui-04-narrow.png" alt="Screenshot: The ScanMole GUI's single-column layout in a narrow window" height="128" />](https://github.com/foundata/scanmole/blob/main/assets/images/screenshots/scanmole-gui-04-narrow.png)
&#160;
[<img src="https://raw.githubusercontent.com/foundata/scanmole/refs/heads/main/assets/images/screenshots/scanmole-cli-01-scan.png" alt="Screenshot: The ScanMole CLI listing devices and scanning a duplex batch to a searchable PDF" height="128" />](https://github.com/foundata/scanmole/blob/main/assets/images/screenshots/scanmole-cli-01-scan.png)
&#160;
[<img src="https://raw.githubusercontent.com/foundata/scanmole/refs/heads/main/assets/images/screenshots/scanmole-cli-02-help.png" alt="Screenshot: The upper half of the ScanMole CLI's --help output" height="128" />](https://github.com/foundata/scanmole/blob/main/assets/images/screenshots/scanmole-cli-02-help.png)
<!-- rumdl-enable MD033 -->


### Example PDF<a id="demo-example-pdf"></a>

A real, unedited result: [`scanmole-demo-scan-bw-300dpi-ix500.pdf`](https://github.com/foundata/scanmole/blob/main/assets/pdfs/scanmole-demo-scan-bw-300dpi-ix500.pdf) (3 pages, 197 KB total, so about 66 KB per page): a ScanSnap iX500 duplex batch of a few pages printed from [`scripts/scanner-evidence/print-pack.ps`](https://github.com/foundata/scanmole/blob/main/scripts/scanner-evidence/print-pack.ps), scanned at the 1-bit black-and-white, 300 dpi defaults and OCRed, giving an impression of both the typical file size and the searchable text layer.


## Installation<a id="installation"></a>

[PyPI package version: scanmole](https://pypi.org/project/scanmole/)
[PyPI package version: scanmole-gui](https://pypi.org/project/scanmole-gui/)
...
For development installs from a repository checkout, see [`DEVELOPMENT.md`](https://github.com/foundata/scanmole/blob/main/DEVELOPMENT.md#getting-started).
...
See [`CONTRIBUTING.md`: Report scanner problems and device quirks](https://github.com/foundata/scanmole/blob/main/CONTRIBUTING.md#issues-scanner-quirks).
...
See [`CONTRIBUTING.md`](https://github.com/foundata/scanmole/blob/main/CONTRIBUTING.md) for how to report issues and submit changes. [Translations](https://github.com/foundata/scanmole/blob/main/DEVELOPMENT.md#translations) are welcome.
...
This project is licensed under the GNU General Public License v3.0 or later (SPDX-License-Identifier: `GPL-3.0-or-later`), see [`LICENSES/GPL-3.0-or-later.txt`](https://github.com/foundata/scanmole/blob/main/LICENSES/GPL-3.0-or-later.txt) for the full text.

The [`REUSE.toml`](https://github.com/foundata/scanmole/blob/main/REUSE.toml) file provides detailed licensing and copyright information in a human- and machine-readable format. This includes parts that may be subject to different licensing or usage terms, such as third-party components. The repository conforms to the [REUSE specification](https://reuse.software/spec/). You can use [`reuse spdx`](https://reuse.readthedocs.io/en/latest/readme.html#cli) to create a SPDX software bill of materials (SBOM).
<!--REUSE-IgnoreEnd-->

[REUSE status](https://api.reuse.software/info/github.com/foundata/scanmole)
