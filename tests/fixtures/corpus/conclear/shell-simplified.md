...
**⭐ Found this useful? Support open-source and star this project:** [GitHub repository](https://github.com/foundata/conclear)
<!-- rumdl-enable MD033 -->
...
[registry options](https://github.com/foundata/conclear/blob/main/ARCHITECTURE.md#publication-and-promotion).
...
Back up keys and host settings separately; see [backup](https://github.com/foundata/conclear/blob/main/docs/backup.md).
...
[configuration reference](https://github.com/foundata/conclear/blob/main/ARCHITECTURE.md#configuration-and-trust-inputs).
...
[backup](https://github.com/foundata/conclear/blob/main/docs/backup.md) for retention and separate key backups.
...
[distributed qualification](https://github.com/foundata/conclear/blob/main/docs/distributed-qualification.md), then assemble
...
[command reference](https://github.com/foundata/conclear/blob/main/ARCHITECTURE.md#command-model).
...
The [JSON schemas](https://github.com/foundata/conclear/blob/main/src/conclear/schemas/) define configuration, profiles,
...
See [backup and retention](https://github.com/foundata/conclear/blob/main/docs/backup.md) for what to preserve, when it can
be deleted, and a daily archive recipe for secure storage.


## Conformance<a id="conformance"></a>

Look up `CCnnnn` failures in the [conformance catalog](https://github.com/foundata/conclear/blob/main/docs/conformance.md).
It also identifies guide requirements that need manual review or external
controls. The [guide options](https://github.com/foundata/conclear/blob/main/docs/conformance.md#guide-options) section lists
supported and unsupported choices.

For implementation details, see [ARCHITECTURE.md](https://github.com/foundata/conclear/blob/main/ARCHITECTURE.md), the
[implementation matrix](https://github.com/foundata/conclear/blob/main/docs/implementation.md) and the
[compatibility inventory](https://github.com/foundata/conclear/blob/main/docs/compatibility-inventory.json).


## Contributing<a id="contributing"></a>

See [`CONTRIBUTING.md`](https://github.com/foundata/conclear/blob/main/CONTRIBUTING.md) for the contribution workflow and
[`DEVELOPMENT.md`](https://github.com/foundata/conclear/blob/main/DEVELOPMENT.md) for the development environment, test tiers
...
[`LICENSES/GPL-3.0-or-later.txt`](https://github.com/foundata/conclear/blob/main/LICENSES/GPL-3.0-or-later.txt) for the full
text.

The [`REUSE.toml`](https://github.com/foundata/conclear/blob/main/REUSE.toml) file provides detailed licensing and copyright
...
[REUSE status](https://api.reuse.software/info/github.com/foundata/conclear)
